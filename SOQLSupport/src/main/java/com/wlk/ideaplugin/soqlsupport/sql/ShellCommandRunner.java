...
public class ShellCommandRunner {
    private static final Logger LOG = Logger.getInstance(ShellCommandRunner.class);
     ...
     */
    public static CompletableFuture<String> executeSqlStringAsync(List<String> command) {
