...
import com.wlk.ideaplugin.apexsupport.language.psi.ApexRuleElementType;
...
public class ApexPsiType {
	...
	public static IElementType apexFile 	= new ApexRuleElementType("apexFile");
	public static IElementType triggerUnit 	= new ApexRuleElementType("triggerUnit");
	public static IElementType triggerCase 	= new ApexRuleElementType("triggerCase");
	public static IElementType triggerBlock 	= new ApexRuleElementType("triggerBlock");
	public static IElementType triggerBlockMember 	= new ApexRuleElementType("triggerBlockMember");
	public static IElementType classUnit 	= new ApexRuleElementType("classUnit");
	public static IElementType typeDeclaration 	= new ApexRuleElementType("typeDeclaration");
	public static IElementType classDeclaration 	= new ApexRuleElementType("classDeclaration");
	public static IElementType enumDeclaration 	= new ApexRuleElementType("enumDeclaration");
	public static IElementType enumConstants 	= new ApexRuleElementType("enumConstants");
	public static IElementType interfaceDeclaration 	= new ApexRuleElementType("interfaceDeclaration");
	public static IElementType typeList 	= new ApexRuleElementType("typeList");
	public static IElementType classBody 	= new ApexRuleElementType("classBody");
	public static IElementType interfaceBody 	= new ApexRuleElementType("interfaceBody");
	public static IElementType classBodyDeclaration 	= new ApexRuleElementType("classBodyDeclaration");
	public static IElementType modifier 	= new ApexRuleElementType("modifier");
	public static IElementType memberDeclaration 	= new ApexRuleElementType("memberDeclaration");
	public static IElementType triggerMemberDeclaration 	= new ApexRuleElementType("triggerMemberDeclaration");
	public static IElementType methodDeclaration 	= new ApexRuleElementType("methodDeclaration");
	public static IElementType constructorDeclaration 	= new ApexRuleElementType("constructorDeclaration");
	public static IElementType fieldDeclaration 	= new ApexRuleElementType("fieldDeclaration");
	public static IElementType propertyDeclaration 	= new ApexRuleElementType("propertyDeclaration");
	public static IElementType interfaceMethodDeclaration 	= new ApexRuleElementType("interfaceMethodDeclaration");
	public static IElementType variableDeclarators 	= new ApexRuleElementType("variableDeclarators");
	public static IElementType variableDeclarator 	= new ApexRuleElementType("variableDeclarator");
	public static IElementType arrayInitializer 	= new ApexRuleElementType("arrayInitializer");
	public static IElementType typeRef 	= new ApexRuleElementType("typeRef");
	public static IElementType arraySubscripts 	= new ApexRuleElementType("arraySubscripts");
	public static IElementType typeName 	= new ApexRuleElementType("typeName");
	public static IElementType typeArguments 	= new ApexRuleElementType("typeArguments");
	public static IElementType formalParameters 	= new ApexRuleElementType("formalParameters");
	public static IElementType formalParameterList 	= new ApexRuleElementType("formalParameterList");
	public static IElementType formalParameter 	= new ApexRuleElementType("formalParameter");
	public static IElementType qualifiedName 	= new ApexRuleElementType("qualifiedName");
	public static IElementType literal 	= new ApexRuleElementType("literal");
	public static IElementType annotation 	= new ApexRuleElementType("annotation");
	public static IElementType elementValuePairs 	= new ApexRuleElementType("elementValuePairs");
	public static IElementType elementValuePair 	= new ApexRuleElementType("elementValuePair");
	public static IElementType elementValue 	= new ApexRuleElementType("elementValue");
	public static IElementType elementValueArrayInitializer 	= new ApexRuleElementType("elementValueArrayInitializer");
	public static IElementType block 	= new ApexRuleElementType("block");
	public static IElementType localVariableDeclarationStatement 	= new ApexRuleElementType("localVariableDeclarationStatement");
	public static IElementType localVariableDeclaration 	= new ApexRuleElementType("localVariableDeclaration");
	public static IElementType statement 	= new ApexRuleElementType("statement");
	public static IElementType ifStatement 	= new ApexRuleElementType("ifStatement");
	public static IElementType switchStatement 	= new ApexRuleElementType("switchStatement");
	public static IElementType whenControl 	= new ApexRuleElementType("whenControl");
	public static IElementType whenValue 	= new ApexRuleElementType("whenValue");
	public static IElementType whenLiteral 	= new ApexRuleElementType("whenLiteral");
	public static IElementType forStatement 	= new ApexRuleElementType("forStatement");
	public static IElementType whileStatement 	= new ApexRuleElementType("whileStatement");
	public static IElementType doWhileStatement 	= new ApexRuleElementType("doWhileStatement");
	public static IElementType tryStatement 	= new ApexRuleElementType("tryStatement");
	public static IElementType returnStatement 	= new ApexRuleElementType("returnStatement");
	public static IElementType throwStatement 	= new ApexRuleElementType("throwStatement");
	public static IElementType breakStatement 	= new ApexRuleElementType("breakStatement");
	public static IElementType continueStatement 	= new ApexRuleElementType("continueStatement");
	public static IElementType accessLevel 	= new ApexRuleElementType("accessLevel");
	public static IElementType insertStatement 	= new ApexRuleElementType("insertStatement");
	public static IElementType updateStatement 	= new ApexRuleElementType("updateStatement");
	public static IElementType deleteStatement 	= new ApexRuleElementType("deleteStatement");
	public static IElementType undeleteStatement 	= new ApexRuleElementType("undeleteStatement");
	public static IElementType upsertStatement 	= new ApexRuleElementType("upsertStatement");
	public static IElementType mergeStatement 	= new ApexRuleElementType("mergeStatement");
	public static IElementType runAsStatement 	= new ApexRuleElementType("runAsStatement");
	public static IElementType expressionStatement 	= new ApexRuleElementType("expressionStatement");
	public static IElementType propertyBlock 	= new ApexRuleElementType("propertyBlock");
	public static IElementType getter 	= new ApexRuleElementType("getter");
	public static IElementType setter 	= new ApexRuleElementType("setter");
	public static IElementType catchClause 	= new ApexRuleElementType("catchClause");
	public static IElementType finallyBlock 	= new ApexRuleElementType("finallyBlock");
	public static IElementType forControl 	= new ApexRuleElementType("forControl");
	public static IElementType forInit 	= new ApexRuleElementType("forInit");
	public static IElementType enhancedForControl 	= new ApexRuleElementType("enhancedForControl");
	public static IElementType forUpdate 	= new ApexRuleElementType("forUpdate");
	public static IElementType parExpression 	= new ApexRuleElementType("parExpression");
	public static IElementType expressionList 	= new ApexRuleElementType("expressionList");
	public static IElementType expression 	= new ApexRuleElementType("expression");
	public static IElementType primary 	= new ApexRuleElementType("primary");
	public static IElementType methodCall 	= new ApexRuleElementType("methodCall");
	public static IElementType dotMethodCall 	= new ApexRuleElementType("dotMethodCall");
	public static IElementType creator 	= new ApexRuleElementType("creator");
	public static IElementType createdName 	= new ApexRuleElementType("createdName");
	public static IElementType idCreatedNamePair 	= new ApexRuleElementType("idCreatedNamePair");
	public static IElementType noRest 	= new ApexRuleElementType("noRest");
	public static IElementType classCreatorRest 	= new ApexRuleElementType("classCreatorRest");
	public static IElementType arrayCreatorRest 	= new ApexRuleElementType("arrayCreatorRest");
	public static IElementType mapCreatorRest 	= new ApexRuleElementType("mapCreatorRest");
	public static IElementType mapCreatorRestPair 	= new ApexRuleElementType("mapCreatorRestPair");
	public static IElementType setCreatorRest 	= new ApexRuleElementType("setCreatorRest");
	public static IElementType arguments 	= new ApexRuleElementType("arguments");
	public static IElementType soqlLiteral 	= new ApexRuleElementType("soqlLiteral");
	public static IElementType query 	= new ApexRuleElementType("query");
	public static IElementType subQuery 	= new ApexRuleElementType("subQuery");
	public static IElementType selectList 	= new ApexRuleElementType("selectList");
	public static IElementType selectEntry 	= new ApexRuleElementType("selectEntry");
	public static IElementType fieldName 	= new ApexRuleElementType("fieldName");
	public static IElementType fromNameList 	= new ApexRuleElementType("fromNameList");
	public static IElementType subFieldList 	= new ApexRuleElementType("subFieldList");
	public static IElementType subFieldEntry 	= new ApexRuleElementType("subFieldEntry");
	public static IElementType soqlFieldsParameter 	= new ApexRuleElementType("soqlFieldsParameter");
	public static IElementType soqlFunction 	= new ApexRuleElementType("soqlFunction");
	public static IElementType dateFieldName 	= new ApexRuleElementType("dateFieldName");
	public static IElementType locationValue 	= new ApexRuleElementType("locationValue");
	public static IElementType coordinateValue 	= new ApexRuleElementType("coordinateValue");
	public static IElementType typeOf 	= new ApexRuleElementType("typeOf");
	public static IElementType whenClause 	= new ApexRuleElementType("whenClause");
	public static IElementType elseClause 	= new ApexRuleElementType("elseClause");
	public static IElementType fieldNameList 	= new ApexRuleElementType("fieldNameList");
	public static IElementType usingScope 	= new ApexRuleElementType("usingScope");
	public static IElementType whereClause 	= new ApexRuleElementType("whereClause");
	public static IElementType logicalExpression 	= new ApexRuleElementType("logicalExpression");
	public static IElementType conditionalExpression 	= new ApexRuleElementType("conditionalExpression");
	public static IElementType fieldExpression 	= new ApexRuleElementType("fieldExpression");
	public static IElementType comparisonOperator 	= new ApexRuleElementType("comparisonOperator");
	public static IElementType value 	= new ApexRuleElementType("value");
	public static IElementType valueList 	= new ApexRuleElementType("valueList");
	public static IElementType signedNumber 	= new ApexRuleElementType("signedNumber");
	public static IElementType withClause 	= new ApexRuleElementType("withClause");
	public static IElementType filteringExpression 	= new ApexRuleElementType("filteringExpression");
	public static IElementType dataCategorySelection 	= new ApexRuleElementType("dataCategorySelection");
	public static IElementType dataCategoryName 	= new ApexRuleElementType("dataCategoryName");
	public static IElementType filteringSelector 	= new ApexRuleElementType("filteringSelector");
	public static IElementType groupByClause 	= new ApexRuleElementType("groupByClause");
	public static IElementType orderByClause 	= new ApexRuleElementType("orderByClause");
	public static IElementType fieldOrderList 	= new ApexRuleElementType("fieldOrderList");
	public static IElementType fieldOrder 	= new ApexRuleElementType("fieldOrder");
	public static IElementType limitClause 	= new ApexRuleElementType("limitClause");
	public static IElementType offsetClause 	= new ApexRuleElementType("offsetClause");
	public static IElementType allRowsClause 	= new ApexRuleElementType("allRowsClause");
	public static IElementType forClauses 	= new ApexRuleElementType("forClauses");
	public static IElementType boundExpression 	= new ApexRuleElementType("boundExpression");
	public static IElementType dateFormula 	= new ApexRuleElementType("dateFormula");
	public static IElementType signedInteger 	= new ApexRuleElementType("signedInteger");
	public static IElementType soqlId 	= new ApexRuleElementType("soqlId");
	public static IElementType soslLiteral 	= new ApexRuleElementType("soslLiteral");
	public static IElementType soslLiteralAlt 	= new ApexRuleElementType("soslLiteralAlt");
	public static IElementType soslClauses 	= new ApexRuleElementType("soslClauses");
	public static IElementType soslWithClause 	= new ApexRuleElementType("soslWithClause");
	public static IElementType searchGroup 	= new ApexRuleElementType("searchGroup");
	public static IElementType fieldSpecList 	= new ApexRuleElementType("fieldSpecList");
	public static IElementType fieldSpec 	= new ApexRuleElementType("fieldSpec");
	public static IElementType fieldList 	= new ApexRuleElementType("fieldList");
	public static IElementType updateList 	= new ApexRuleElementType("updateList");
	public static IElementType updateType 	= new ApexRuleElementType("updateType");
	public static IElementType networkList 	= new ApexRuleElementType("networkList");
	public static IElementType soslId 	= new ApexRuleElementType("soslId");
	public static IElementType id 	= new ApexRuleElementType("id");
	public static IElementType anyId 	= new ApexRuleElementType("anyId");
