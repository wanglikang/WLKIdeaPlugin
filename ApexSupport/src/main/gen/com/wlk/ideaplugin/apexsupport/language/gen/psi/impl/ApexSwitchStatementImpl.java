...
public class ApexSwitchStatementImpl extends ASTWrapperPsiElement implements ApexSwitchStatement {

  public ApexSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ApexWhenControl> getWhenControlList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ApexWhenControl.class);
  }
