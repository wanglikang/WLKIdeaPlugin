...
public class ApexInterfaceBodyImpl extends ASTWrapperPsiElement implements ApexInterfaceBody {
  ...
  @Override
  @NotNull
  public List<ApexInterfaceBodyDeclaration> getInterfaceBodyDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ApexInterfaceBodyDeclaration.class);
  }
