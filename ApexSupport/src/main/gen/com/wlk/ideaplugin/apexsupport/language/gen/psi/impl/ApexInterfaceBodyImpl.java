...
public class ApexInterfaceBodyImpl extends ASTWrapperPsiElement implements ApexInterfaceBody {
  ...
  @Override
  @NotNull
  public List<ApexInterfaceMethodDeclaration> getInterfaceMethodDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ApexInterfaceMethodDeclaration.class);
  }
