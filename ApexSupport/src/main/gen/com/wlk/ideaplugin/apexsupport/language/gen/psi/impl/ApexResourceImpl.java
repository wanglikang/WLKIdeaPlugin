...
public class ApexResourceImpl extends ASTWrapperPsiElement implements ApexResource {

  public ApexResourceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ApexClassOrInterfaceType getClassOrInterfaceType() {
    return findNotNullChildByClass(ApexClassOrInterfaceType.class);
  }
