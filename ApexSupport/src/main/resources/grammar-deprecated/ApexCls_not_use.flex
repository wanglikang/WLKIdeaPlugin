...
//   }
	...
	private IElementType symbol(String typeName) {
        return  new ApexTokenType(typeName, yyline+1,yycolumn+1);
//		return ApexTypes.createElementTypeByName(typeName, yyline+1, yycolumn+1);
	}

	// 这个方法，以后再用
	private IElementType symbol(String typeName, Object value) {
         return  new ApexTokenType(typeName, yyline+1,yycolumn+1,value);
